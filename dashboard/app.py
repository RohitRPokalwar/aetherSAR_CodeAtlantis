...
def main():
    ...
    with st.sidebar:
        ...
        page = st.radio(
            ...
            ["🏠 Home", "🔍 Detection", "🗺️ Map View", "📊 Analytics",
             "📈 Metrics", "⚠️ Alerts", "📄 Reports", "🏋️ Training",
             "🔬 Approach"],
    ...
    if page == "🏠 Home":
        ...
        from dashboard.pages.metrics import show_metrics_page
        show_metrics_page()
    elif page == "⚠️ Alerts":
        ...
        from dashboard.pages.training import show_training_page
        show_training_page()
    elif page == "🔬 Approach":
        from dashboard.pages.approach import show_approach_page
        show_approach_page()
...
def show_home():
    ...
    with col1:
        st.metric("🔍 Detection", "YOLOv8s", "ByteTrack")
    with col2:
    ...
    with col1:
        ...
        st.markdown("""
        - **YOLOv8s + ByteTrack** — Real-time ship detection & tracking
        - **CFAR Pre-Screening** — Radar-native target detection
        - **Soft-NMS** — Gaussian-decay tile merging
        ...
        - **Morphological Post-Processing** — Intensity + shape filtering
        """)
    ...
    with col2:
        ...
        - **Interactive Metrics** — PR curves, F1 analysis
        """)
        ...
        4. Check P/R metrics in **📈 Metrics**
        5. Monitor alerts in **⚠️ Alerts**
        6. Generate reports in **📄 Reports**
        7. Fine-tune model in **🏋️ Training**
        8. Read methodology in **🔬 Approach**
        """)
